...
class CompilerDetection(object):
    # Necessary for OSX. See https://github.com/assaytools/assaytools/issues/576
...
def write_version_py(VERSION, ISRELEASED, filename='bitc/version.py'):
    cnt = """
# THIS FILE IS GENERATED FROM BAYESIAN ITC SETUP.PY
